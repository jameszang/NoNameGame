------------------------------------------------------------------------
SF Proverbial Gothic - Version 1.0
------------------------------------------------------------------------

The following fonts are included:

 - SF Proverbial Gothic
 - SF Proverbial Gothic Bold
 - SF Proverbial Gothic Bold Oblique
 - SF Proverbial Gothic Oblique
 - SF Proverbial Gothic Condensed
 - SF Proverbial Gothic Condensed Oblique
 - SF Proverbial Gothic Extended
 - SF Proverbial Gothic Extended Oblique

------------------------------------------------------------------------
SF Proverbial Gothic - Version 1.0 - Features
------------------------------------------------------------------------
